    ...
    return (
        <div className="min-h-screen bg-light-bg font-mplus text-slate-800">
            ...
            <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 pt-8">
                ...
                <div className="mb-8">
                     <h2 className="text-xl font-bold text-slate-700 mb-4 border-b-2 border-secondary pb-2 font-kaisei">必ず出ていくお金（固定費）</h2>
               ...
               <div className="mb-8">
                   <div className="flex items-center justify-between mb-4">
                       <h2 className="text-xl font-bold text-slate-700 border-b-2 border-secondary pb-2 font-kaisei">使ったお金メモ</h2>
                       <button
                           onClick={() => {
                           ...
                           className="bg-secondary hover:bg-pink-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2"
                       >
                               ...
                               <div key={cat.id} className="bg-white rounded-lg shadow-sm border border-slate-200 p-4 flex flex-col h-full">
                                   <div className="flex items-center mb-2 gap-2">
                                       <input
                                           ...
                                           className="text-lg font-bold text-slate-800 bg-transparent border-b border-dashed border-secondary focus:border-secondary outline-none flex-grow min-w-0 font-kaisei"
                                       />
                                       <button
                                           onClick={() => {
                ...
                <div className="mb-8">
                     <h2 className="text-xl font-bold text-slate-700 mb-4 border-b-2 border-secondary pb-2 font-kaisei">今月のまとめ</h2>
                ...
                <div className="mt-8">
                    <h2 className="text-xl font-bold text-slate-700 mb-4 border-b-2 border-secondary pb-2 font-kaisei">メモ欄</h2>
                    <textarea
                        value={memo}
