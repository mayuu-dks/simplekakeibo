        ...
        {isAdding ? (
          <form onSubmit={handleAddSubmit} className="space-y-2">
            <div className="flex items-center space-x-2">
              ...
              <input name="expenseAmount" type="number" placeholder="金額" onFocus={e => e.target.select()} className="w-24 p-1 text-sm border rounded bg-slate-50 focus:ring-1 focus:ring-pink-400 focus:outline-none" required min="0" />
